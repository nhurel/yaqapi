...
import me.hurel.hqlbuilder.builder.NullConditionHibernateQueryBuilder;
...
public class WhereTest {
	...
	User user = queryOn(new User());
	ConditionHibernateQueryBuilder<String> query = select(user).from(user).where(user.getFirstName()).isEqualTo("toto");
	...
	User user = queryOn(new User());
	ConditionHibernateQueryBuilder<String> query = select(user).from(user).where(user.getFirstName()).isEqualTo(user.getLastName());
	String queryString = query.getQueryString();
	...
	User user = queryOn(new User());
	ConditionHibernateQueryBuilder<String> query = select(user).from(user).where(user.getFirstName()).isEqualTo(user.getAdress().getStreet());
	String queryString = query.getQueryString();
	...
	User user = queryOn(new User());
	ConditionHibernateQueryBuilder<String> query = select(user).from(user).rightJoin(user.getAdress()).where(user.getFirstName()).isEqualTo(user.getAdress().getStreet());
	String queryString = query.getQueryString();
	...
	ConditionHibernateQueryBuilder<String> query = select(user).from(user).andFrom(user2).where(user.getLastName()).isEqualTo(user2.getLastName());
	String queryString = query.getQueryString();
	...
	User user = queryOn(new User());
	User user2 = andQueryOn(new User());
	ConditionHibernateQueryBuilder<String> query = select(user.getFirstName(), user2.getFirstName()).from(user).andFrom(user2).where(user.getLastName())
		.isEqualTo(user2.getLastName());
	String queryString = query.getQueryString();
	...
	User user = queryOn(new User());
	NullConditionHibernateQueryBuilder<List<User>> query = select(user).from(user).where(user.getChildren()).isNull();
	...
	NullConditionHibernateQueryBuilder<String> query = select(user.getFirstName(), user2.getFirstName()).from(user).andFrom(user2).where(user.getLastName())
		.isEqualTo(user2.getLastName()).and(user.getFirstName()).isNull();
	String queryString = query.getQueryString();
	...
	User user = queryOn(new User());
	User user2 = andQueryOn(new User());
	NullConditionHibernateQueryBuilder<?> query = select(user.getFirstName(), user2.getFirstName()).from(user).andFrom(user2).where(user.getLastName())
		.isEqualTo(user2.getLastName()).and(user.getChildren()).isNull();
	String queryString = query.getQueryString();
