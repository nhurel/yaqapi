...
public class ProxyOnlyTest {
    ...
    public void select_deep_properties_on_one_entity() {
        Adress adress = queryOn(new Adress());
        String queryString = select(adress.getNumber(), adress.getStreet(), adress.getCity().getName(), adress.getCity().getCountry().getName())
                .from(adress).getQueryString();
    ...
    public void select_deep_properties_on_joined_entities() {
        ...
        String queryString = select(adress.getNumber(), adress.getStreet(), adress.getCity().getName(), city.getCountry().getName()).from(adress)
                .innerJoin(city).getQueryString();
        assertThat(queryString).isEqualTo(
                "SELECT adress.number, adress.street, city.name, city.country.name FROM Adress adress INNER JOIN adress.city city ");
    }
    ...
    public void select_from_all_join_types() {
        User user = queryOn(new User());
        String queryString = select(user.getFirstName(), user.getAdress().getNumber(), user.getAdress().getCity(),
                user.getAdress().getCity().getName(), user.getAdress().getCity().getCountry().getName()).from(user).innerJoin(user.getAdress())
                .leftJoin(user.getAdress().getCity()).rightJoin(user.getAdress().getCity().getCountry()).getQueryString();
    ...
    public void select_from_join_on_deep_property() {
        User user = queryOn(new User());
        String queryString = select(user.getFirstName(), user.getAdress().getNumber(), user.getAdress().getCity().getName(),
                user.getAdress().getCity().getCountry().getName()).from(user).rightJoin(user.getAdress().getCity().getCountry()).getQueryString();
    ...
    public void select_from_join_on_deep_property_with_alias() {
        ...
        String queryString = select(user.getFirstName(), adress.getNumber(), adress.getCity().getName(), country.getName()).from(user)
                .rightJoin(country).getQueryString();
    ...
    public void select_from_join_on_deep_property_with_city_alias() {
        ...
        String queryString = select(user.getFirstName(), user.getAdress().getNumber(), city.getName(), country.getName()).from(user)
                .rightJoin(country).getQueryString();
    ...
    public void select_with_fetching() {
        ...
        assertThat(queryString)
                .isEqualTo(
                        "SELECT user FROM User user INNER JOIN FETCH user.adress adress LEFT JOIN FETCH adress.city city RIGHT JOIN FETCH city.country country ");
